 ...
 * contents of Bool.xs. Do not edit this file, edit Bool.xs instead.
 *
...
XS_EUPXS(XS_My__Bool_XrmGetResource); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_My__Bool_XrmGetResource)
{
    dVAR; dXSARGS;
    if (items != 2)
       croak_xs_usage(cv,  "str_name, str_class");
    {
...
extern "C"
#endif
XS_EXTERNAL(boot_My__Bool); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_My__Bool)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("My::Bool::XrmGetResource", XS_My__Bool_XrmGetResource);
#if PERL_VERSION_LE(5, 21, 5)
